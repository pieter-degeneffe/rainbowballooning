  <?php if (!empty($nodes)): ?>
    <div id="portfolio-wrapper">
      ...
      <div class="four columns portfolio-item">
      	<div class="picture">
			<a href="/filmpjes" title="België 2012">
				<img typeof="foaf:Image" src="/sites/all/themes/rainbowballooning/images/youtube.png" width="460" height="290" alt="Rainbow Ballooning filmpjes">
