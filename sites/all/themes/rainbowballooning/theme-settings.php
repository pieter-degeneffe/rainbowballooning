...
function rainbowballooning_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['settings']['header_contact']['header_contact_email'] = array(
      ...
      '#type' => 'textfield',
      '#default_value' => theme_get_setting('header_contact_email', 'rainbowballooning'),
  );
  $form['settings']['header_contact']['header_contact_phone'] = array(
      '#title' => t('Phone number'),
      '#type' => 'textfield',
      '#default_value' => theme_get_setting('header_contact_phone', 'rainbowballooning'),
  );
  ...
  foreach ($social_links as $name => $label) {
    ...
    $form['settings']['social_links'][$name . '_url'] = array(
        '#type' => 'textfield',
        '#title' => $label,
        '#default_value' => theme_get_setting($name . '_url', 'rainbowballooning'),
    );
  }
  ...
  $form['settings']['portfolio']['default_portfolio'] = array(
      ...
      '#default_value' => theme_get_setting('default_portfolio', 'rainbowballooning'),
  );
  ...
  $form['settings']['portfolio']['default_nodes_portfolio'] = array(
      ...
      '#default_value' => theme_get_setting('default_nodes_portfolio', 'rainbowballooning'),
  );
  ...
  $form['settings']['footer']['footer_copyright_message'] = array(
      ...
      '#default_value' => theme_get_setting('footer_copyright_message', 'rainbowballooning'),
  );
  ...
  $dir = drupal_get_path('theme', 'rainbowballooning') . DIRECTORY_SEPARATOR . 'css' . DIRECTORY_SEPARATOR . 'colors';
  ...
  $form['settings']['skin']['theme_layout_style'] = array(
      ...
      '#default_value' => theme_get_setting('theme_layout_style', 'rainbowballooning'),
  );
  $form['settings']['skin']['theme_color'] = array(
      '#type' => 'select',
      '#title' => t('Select default color'),
      '#default_value' => theme_get_setting('theme_color', 'rainbowballooning'),
      '#options' => $css_files,
  );
  ...
  $form['settings']['skin']['theme_background_color'] = array(
      ...
      '#default_value' => theme_get_setting('theme_background_color', 'rainbowballooning'),
      '#attributes' => array('class' => array('colorSelector')),
  );


  // bg background
  $dir = drupal_get_path('theme', 'rainbowballooning') . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'bg';
  ...
  $form['settings']['skin']['theme_background_image'] = array(
      ...
      '#type' => 'select',
      '#default_value' => theme_get_setting('theme_background_image', 'rainbowballooning'),
      '#options' => $bg_files,
...
//slider
  ...
  $banners = rainbowballooning_get_banners();
  ...
  foreach ($banners as $image_data) {
    $form['slider']['banner']['images'][$i] = array(
        ...
        'image' => _rainbowballooning_banner_form($image_data),
    );
  ...
  $form['#submit'][] = 'rainbowballooning_settings_submit';
}

function _rainbowballooning_custom_js() {
