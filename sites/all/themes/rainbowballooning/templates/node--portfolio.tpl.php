...
<div id="node-<?php print $node->nid; ?>" class="post <?php if ($page): ?><?php print 'post-page '; ?> <?php endif; ?><?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php endif; ?>
	...
	<div id="portfolio-wrapper">
		 ...
		 -->
		 <div class="four columns portfolio-item2">
		 	<div class="picture">
				<?php $image_full = file_create_url($image_field[$x]['uri']);?>
				<a href="<?php print $image_full; ?>" rel="image" title="<?php print $node->title; ?>">
				  	<?php print theme('image_style', array('style_name' => $style_name, 'path' => $img['uri'])); ?>
				  	<div class="image-overlay-zoom"></div>
				  </a>
		 	</div>
		</div>
...
<?php if (!empty($nodes)): ?>
  ...
  <div class="sixteen columns">
    <!-- Headline -->
    <div style="margin-top: 5px;" class="headline"><h3><?php print t('Overige albums'); ?></h3></div>
  </div>
