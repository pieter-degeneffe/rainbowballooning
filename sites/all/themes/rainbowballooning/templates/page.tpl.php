    ...
    <div id="header">
      ...
      <div class="eight columns">
        ...
        <ul class="social-icons">
          <?php
          $facebook = theme_get_setting('facebook_url', 'rainbowballooning');
          $twitter = theme_get_setting('twitter_url', 'rainbowballooning');
          $dribbble = theme_get_setting('dribbble_url', 'rainbowballooning');
          $linkedin = theme_get_setting('linkedin_url', 'rainbowballooning');
          $pintrest = theme_get_setting('pintrest_url', 'rainbowballooning');
          $youtube = theme_get_setting('youtube_url', 'rainbowballooning');
          ?>
        ...
        <div id="contact-details">
          <?php
          $header_contact_mail = theme_get_setting('header_contact_email', 'rainbowballooning');
          $header_contact_phone = theme_get_setting('header_contact_phone', 'rainbowballooning');
          ?>
  ...
  <div class="container">
    ...
    <div class="sixteen columns">
      <div id="footer-bottom">
        <?php print theme_get_setting('footer_copyright_message', 'rainbowballooning'); ?>
