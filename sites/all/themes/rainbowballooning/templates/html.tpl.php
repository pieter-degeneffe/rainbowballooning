...
<!--[if (gte IE 9)|!(IE)]><!--><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>"<?php print $rdf_namespaces; ?>><!--<![endif]-->
  ...
  <head profile="<?php print $grddl_profile; ?>">
    ...
    <?php
    $layout_style = theme_get_setting('theme_layout_style', 'rainbowballooning');
    if ($layout_style == 'boxed.css'):
      ?>
      <?php
      $bg_image = theme_get_setting('theme_background_image', 'rainbowballooning');
      $bg_color = theme_get_setting('theme_background_color', 'rainbowballooning');
      if (!empty($bg_image)) {
