...
function _rainbowballooning_add_css() {
  ...
  $theme_layout_style = theme_get_setting('theme_layout_style', 'rainbowballooning');

  //boxed or full
  drupal_add_css($theme_path . '/css/' . $theme_layout_style);

  $default_color = theme_get_setting('theme_color', 'rainbowballooning');

  drupal_add_css($theme_path . '/css/colors/' . $default_color);

  drupal_add_css($theme_path . '/css/rainbowballooning.css');
}

/**
 * Implements hook_preprocess_html().
 */
function rainbowballooning_preprocess_html(&$variables) {

  $theme_path = path_to_theme();

  _rainbowballooning_add_css();
  ...
  drupal_add_html_head(
      ...
      '#attributes' => array(
          ...
          ), 'rainbowballooning:viewport_meta'
  );
}

function rainbowballooning_preprocess_page(&$vars) {
  ...
  // banner slider
  if (variable_get('theme_rainbowballooning_first_install', TRUE)) {

    _rainbowballooning_install();
  }


  $banners = rainbowballooning_show_banners();
  $vars['slider'] = rainbowballooning_banners_markup($banners);
...
function rainbowballooning_format_comma_field($field_category, $node, $limit = NULL) {
  $category_arr = array();
  $category = '';
...
function rainbowballooning_preprocess_node(&$variables) {
...
function rainbowballooning_form_alter(&$form, &$form_state, $form_id) {
...
function rainbowballooning_status_messages(&$variables) {
...
function rainbowballooning_tagadelic_weighted(array $vars) {
  $terms = $vars['terms'];
...
function rainbowballooning_pager($variables) {
  $tags = $variables['tags'];
...
function rainbowballooning_table($variables) {
...
function rainbowballooning_breadcrumb($variables) {
